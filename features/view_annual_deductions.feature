...
so that I can see a detailed breakdown of how much tax I am paying annually.
  ...
  Scenario: Calculate deductions against the average UK salary
    ...
    | Tax deductions                  |  £3,180.00 |
    | National Insurance contribution |  £2,212.80 |
  ...
  Scenario: Calculate deductions against the UK Prime Minister's salary
    ...
    | Tax deductions                  |  £50,643.00 |
    | National Insurance contribution |   £6,121.30 |
  ...
  Scenario: Calculate deductions against a senior London banker's salary
    ...
    | Personal allowance              |         £0.00 |
    | Tax deductions                  |   £571,143.00 |
    | National Insurance contribution |    £29,271.30 |
